...
decl:
	string_decl decl | var_dec1 dec1 | empty
...
stmt:
	base_stmt | if_stmt | loop_stmt 

base_stmt:
	assign_stmt | read_stmt | write_stmt | control_stmt
...
for_stmt:
	FOR ( init_stmt ; cond ; incr_stmt ) decl stmt_list ENDFOR
